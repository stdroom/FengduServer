...
<link rel="icon" href="${easyuiUrl}/favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="${easyuiUrl}/favicon.ico" type="image/x-icon" />
<link rel="bookmark" href="${easyuiUrl}/favicon.ico" type="image/x-icon" />
<!-- ** Javascript ** -->
